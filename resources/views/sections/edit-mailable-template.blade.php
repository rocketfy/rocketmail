                            ...
                            @foreach($templateData['view_data'] as $param)
                                ...
                                @if (isset($param['data']['type']) && $param['data']['type'] === 'model')
                                    <div class="btn-group dropright">
                                      <button type="button" class="btn btn-primary btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" rocketmail-data-toggle="tooltip" data-placement="top" title="Elequent Model">
                                ...
                                @elseif(isset($param['data']['type']) && $param['data']['type'] === 'elequent-collection')
                                    ...
                                    <button type="button" class="btn btn-info btn-sm view_data_param" rocketmail-data-toggle="tooltip" data-placement="top" title="Elequent Collection" param-key="{{ $param['key'] }}">
                                    <i class="fa fa-table mr-1" aria-hidden="true"></i>{{ $param['key'] }}
                                    </button>

                                @elseif(isset($param['data']['type']) && $param['data']['type'] === 'collection')

                                    <button type="button" class="btn btn-success btn-sm view_data_param" rocketmail-data-toggle="tooltip" data-placement="top" title="Collection" param-key="{{ $param['key'] }}">
                                    <i class="fa fa-table mr-1" aria-hidden="true"></i>{{ $param['key'] }}
                                    </button>

                                @else
                                    <button type="button" class="btn btn-secondary btn-sm view_data_param" rocketmail-data-toggle="tooltip" data-placement="top" title="Simple Variable" param-key="{{ $param['key'] }}">
