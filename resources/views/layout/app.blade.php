...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('vendor/rocketmail/css/rocketmail-app.min.css') }}">
    <!-- Font Awesome -->
    ...
    <script src="{{ asset('vendor/rocketmail/js/rocketmail-app.js') }}"></script>
...
@section('content')
    ...
    <div class="row m-3">
        ...
        @if ( request()->route()->getName() !== 'backetfy.mails.newTemplate' && 
            ...
            @include('rocketmail::layout.sidebar')
